...
.EQU BUTTON1 = PORTB4 ; Button 1 ansluten till pin 12 (PORTB3)
.EQU BUTTON2 = PORTB5 ; Button 2 ansluten till pin 13 (PORTB4)
...
ISR_PCINT0:
   ...
   STS TIMSK0, R16 ; Sätter på Timer 0, som räknar upp 300 ms.
	IN R24, PINB
	ANDI R24, (1 << BUTTON1)
	BREQ ISR_PCINT0_2
	RCALL timer1_toggle 
...
timer2_off:
	CLR R24					  
	STS TIMSK2, R24 ; TIMSK2 = 0;			  
	IN R24, PORTB	 ; PORTB &= ~(1 << LED2)
	ANDI R24, ~(1 << LED2)	  
	OUT PORTB, R24
    RET
